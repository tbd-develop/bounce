...
class Session implements ArrayAccess, ISession
{
    ...
    private function __construct( )
    {
        ...
        $this->_siteProfile = $this->_configuration->GetProfile();

        $this->_sessionExpiry = $this->_configuration->GetSite()->sessionLength;
        $this->_cookieName = $this->_siteProfile->cookie->name;
        $this->_cookiePath = $this->_siteProfile->cookie->path;
        $this->_cookieDomain = $this->_siteProfile->cookie->domain;
    }
